...
def read_train_split_to_str(dataset_dir):
    ...
    image_dir = os.path.join(dataset_dir, "resize_image_train")
...
def read_train_split_to_image(dataset_dir):
    ...
    (ndarray, ndarray, ndarray)
        ...
        * Tensor of images in BGR color space of shape 153x150x3.
    ...
    images = np.zeros((len(filenames), 130, 130, 3), np.uint8)
